...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //
        // You are allowed to use the one variable called scanner for your
        // Scanner instance. You can use as many other variables as you
        // need, but they must must all be called x. That includes any
        // class instances loop control variables that you may include
        // to use.
        //
        // If you use a class, the class must be called X (capital), but
